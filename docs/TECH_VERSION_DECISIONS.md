...
| ----------------------------- | -------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Node.js                       |            `24.20.0` | Current local Node 24 LTS patch on the [official release table](https://nodejs.org/en/about/previous-releases). `.node-version` pins it; the package engine accepts Vercel's current `24.19.0` Node 24 runtime for the private preview. |
